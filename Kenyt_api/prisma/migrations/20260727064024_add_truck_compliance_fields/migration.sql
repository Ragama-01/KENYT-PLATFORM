...
-- AddForeignKey
ALTER TABLE "truck_compliance" ADD CONSTRAINT "truck_compliance_truck_id_fkey" FOREIGN KEY ("truck_id") REFERENCES "Truck"("truckid") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "drivers" ADD CONSTRAINT "drivers_truck_id_fkey" FOREIGN KEY ("truck_id") REFERENCES "Truck"("truckid") ON DELETE SET NULL ON UPDATE CASCADE;
